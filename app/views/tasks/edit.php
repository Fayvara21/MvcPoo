            ...
            <div class="col-12 col-lg-4">
                ...
                <div id="approFields" style="display: <?= $selectedType === 'appro' ? 'block' : 'none' ?>;">
                    <div class="card shadow-sm border-0 mb-3 p-3">
                        ...
                        <input class="form-control mb-2" name="appro_pn" placeholder="PN"
                            value="<?= e($appro['pn'] ?? '') ?>">
                        <input class="form-control mb-2" type="number" name="appro_nb"
                            value="<?= (int) ($appro['nb'] ?? 1) ?>">

                        <hr>

                        <input class="form-control mb-2" name="appro_designation" placeholder="Désignation"
                            value="<?= e($appro['designation'] ?? '') ?>">
                ...
                <div id="retourFields" style="display: <?= $selectedType === 'retour' ? 'block' : 'none' ?>;">
                    <div class="card shadow-sm border-0 p-3">
                        ...
                        <input class="form-control mb-2" name="retour_pn" placeholder="PN"
                            value="<?= e($retour['pn'] ?? '') ?>">
                        <input class="form-control mb-2" type="number" name="retour_nb"
                            value="<?= (int) ($retour['nb'] ?? 1) ?>">
